...
function cyberHacker() {
	...
	switch (switchcase) {
		...
		case 2:
			...
			break;
		case 3:
			return `${randomChoice("I","WE","THEY","ME","BUGS","GODS","PIGS","DOGS","THEDEAD")+randomChoice("KILL","BE","LIKE","HATE","LOVE","KNOW","EAT","RUN","HACK","SEE","SHOCK","-R-IN-","SAVE","2","4")+randomChoice("YOU","US","GOATS","BUGS","BEES","PIGS","CODE","ALL","ANY1","NO1","GODS","LULZ")+"."+randomChoice("EXE","EXEC","DLL","PHP","JS","SYS","TROJ","WORM","HAX","MEM")}, a sentient ${randomChoice("computer virus","piece of malware","computer worm")} that ${randomChoice("aces the Turing Test","satisfies all criteria for life")} and that is so thoroughly distributed across ${randomChoice("the net","the web","modern tech")} that you can open up a terminal on any ${randomChoice("machine","server","computer")} and ${randomChoice("hire it to hack into systems it has infected","try to convince it hack into systems it has infected", "discuss the terms of a hacking contract you would like it to complete")}.`;
			break;
		case 4:
			let fname = "";
			if (gend[3] == "woman") {
