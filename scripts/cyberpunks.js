...
function cyberForger() {
	...
	switch (switchcase) {
		...
		case 5:
			...
			break;
		case 6:
			return `${randomChoice("Otto","Hilgard","Brot","Wulf","Ranier","Gerhard","Horst","Jürgen","Uwe","Helga","Hilda","Ursula","Lena","Anja","Birgit","Ingrid")} ${randomChoice("Wil","Bruns","Fleish","Grün","Rot","Blau","Himmel","Maus","Uhr","Zeit","Vogel","Spitz","Strahlen","Röntgen","Wissen")+randomChoice("hund","wick","mark","wald","welt","braun","helm","seher","malen","werk","schirm","kunst","berger","mann","weg","maier","feldt","berg","biegel","schaft")}, ${randomChoice("white-haired","grey-haired","weathered and lanky","lanky and angular")} ${randomChoice("Swiss-German","German","Prussian","Weimar","Austrian","Austro-Hungarian","Dutch-German","Düsseldorf-born","Zurich-born")} ${randomChoice("watchmaker","clockmaker","maker of hand-crafted nanochips,","nano-artist","crafter of handmade boutique microchips,")} ${randomChoice("outfitted with","sporting","equipped with")} ${randomChoice("permanently-affixed magnification goggles","enormous magnification irises","magnification lens implants")} as well as fingertips that can ${randomChoice("flip open","be taken off")} to reveal the ${randomChoice("miniscule","tiny")} ${randomChoice("tools","paintbrushes and screwdrivers","soldering tools","tools and brushes")} ${randomChoice("necessary","required","needed")} for ${randomChoice("","painstakingly ")}delicate work.`
...
function cyberHacker() {
	...
	switch (switchcase) {
		...
		case 2:
			...
			break;
		case 3:
			return `${randomChoice("I","WE","THEY","ME","BUGS","GODS","PIGS","DOGS","GOVS","THEDEAD","JANUS","AUTOEXEC")+randomChoice("KILL","BE","LIKE","HATE","LOVE","KNOW","EAT","RUN","HACK","SEE","SHOCK","-R-IN-","SAVE","2","4","BETRAY","PLUS","DIVIDE")+randomChoice("YOU","US","GOATS","BUGS","BEES","PIGS","CODE","ALL","ANY1","NO1","GODS","LULZ","FAITH","POWER","LOVE")+"."+randomChoice("EXE","EXECUTE","DLL","PHP","JS","SYS","TROJ","WORM","HAX","MEM")}, a sentient ${randomChoice("computer virus","piece of malware","computer worm")} that ${randomChoice("aces the Turing Test","satisfies all criteria for life")} and that is so thoroughly distributed across ${randomChoice("the net","the web","modern tech")} that you can open up a terminal on any ${randomChoice("machine","server","computer")} and ${randomChoice("hire it to hack into systems it has infected","try to convince it hack into systems it has infected", "discuss the terms of a hacking contract you would like it to complete")}.`;
			break;
		case 4:
			let fname = "";
			if (gend[3] == "woman") {
			...
			break;
		case 5:
			return `${randomChoice("A","Ja","Cha","Gra","Ta","Ra","Bra")+randomChoice("i","y")+"d"+randomChoice("e","e","a","i")+"n "+randomChoice("Washington","Pierce","Franklin","Taylor Thomas","Carter")}, a ${randomChoice("too-cool-for-school","snarky","smack-talking","mannerless","forum-trolling")} ${randomChoice("skate","hover","surf","rocket","magno")}boarding ${randomChoice("bill","trill","tetr","yott","picoll","megall","quint")+"ennial"}, always dressed in his signature ${randomChoice("grey","black","neon","opalescent","silver")} ${randomChoice("hoodie","duster","baseball cap","fedora","mirrorshades")} and ${randomChoice("sneakers","tennis shoes")}, always insistent on joining the strike team to 3D-print improvised ${randomChoice("tools","weapons","traps for security")}.`;
			break;
		case 6:
			return ``;
			break;
