...
function cyberHacker() {
	...
	switch (switchcase) {
		...
		case 4:
			...
			break;
		case 5:
			return `${randomChoice("A","Ja","Cha","Gra","Ta","Ra","Bra")+randomChoice("i","y")+"d"+randomChoice("e","e","a","i")+"n "+randomChoice("Washington","Pierce","Franklin","Taylor Thomas","Carter")}, a ${randomChoice("too-cool-for-school","sarky","smack-talking","mannerless","forum-trolling")} ${randomChoice("skate","hover","surf","rocket","magno")}boarding ${randomChoice("bill","trill","tetr","yott","picoll","megall","quint")+"ennial"} who always wears his signature ${randomChoice("grey","black","neon","opalescent","silver")} ${randomChoice("hoodie","duster","baseball cap","fedora","mirrorshades")} and ${randomChoice("sneakers","tennis shoes")}, and who loves ${randomChoice("to get his hands dirty","fieldwork")} and so insists on joining the heist strike team to 3D-print improvised ${randomChoice("tools","weapons","traps for security")}.`;
			break;
		case 6:
			return ``;
			break;
